...
class CatallogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $registroNuevo->titulo = $request->input('title');
        $registroNuevo->anyo = $request->input('year');
        $registroNuevo->director = $request->input('director');
        $registroNuevo->poster = $request->input('poster');
        $registroNuevo->sinopsis = $request->input('synopsis');
        $registroNuevo->save();
        $url = action([CatallogController::class, 'getShow'], ['id' => $registroNuevo->id]);
        return redirect($url);
    }
